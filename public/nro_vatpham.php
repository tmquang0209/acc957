        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center" style="font-family:Roboto; margin-bottom: 20px;">
                    <h2 style="color: #19b1ff;">Ngọc rồng Online - VẬT PHẨM</h2>
...
$data = $db->query("SELECT * FROM `nick` WHERE `loainick` = '2' AND `status` = '0' $id $money $field01 $field02 $field03 $field04 $field05 LIMIT $from,$limit");
}else{
$data = $db->query("SELECT * FROM `nick` WHERE `loainick` = '2' AND `status` = '0' LIMIT $from,$limit");
}
foreach($data as $row){
                                ...
                                <div class="classWithPad">
                                    ...
                                    <div class="attribute_info">
                                        <div class="row">
                                                    ...
                                                    <div class="col-xs-6 a_att">
                                                        Vật phẩm: <b><?=load_info4($row['info4']);?></b>
                                                    </div>
                                                    <div class="col-xs-6 a_att">
                                                        Loại đồ: <b><?=load_info5($row['info5']);?></b>
                                                    </div>
                                        </div>
                                    </div>
                                    <div class="a-more">
...
<?php } ?>                         
                    ...
                    <div class="dataTables_wrapper no-footer">
                        ...
                        <?php 
$tong = $db->query("SELECT * FROM `nick` WHERE `loainick` = '2' AND `status` = '0'")->rowcount();
if ($tong > $sotin1trang){
    if(isset($_GET)){
if($id != null || $money != null || $field01 != null || $field02 != null || $field03 != null || $field04 != null || $field05 != null){
