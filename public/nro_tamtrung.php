...
<select class="form-control" id="Field04" name="Field04"><option value="">Bông tai</option>
...
$data = $db->query("SELECT * FROM `nick` WHERE `loainick` = '1' AND `status` = '0' $id $money $field01 $field02 $field03 $field04 LIMIT $from,$limit");
}else{
$data = $db->query("SELECT * FROM `nick` WHERE `loainick` = '1' AND `status` = '0' LIMIT $from,$limit");
}
foreach($data as $row){
                                ...
                                <div class="classWithPad">
                                    ...
                                    <div class="attribute_info">
                                        <div class="row">
                                                    ...
                                                    <div class="col-xs-6 a_att">
                                                        Bông tai: <b><?=load_info4($row['info4']);?></b>
                                                    </div>
                                        </div>
                                    </div>
                                    <div class="a-more">
...
<?php } ?>                         
                    ...
                    <div class="dataTables_wrapper no-footer">
                        ...
                        <?php 
$tong = $db->query("SELECT * FROM `nick` WHERE `loainick` = '1' AND `status` = '0'")->rowcount();
if ($tong > $sotin1trang){
    if(isset($_GET)){
