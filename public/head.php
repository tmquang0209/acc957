...
<head>
    ...
    <meta name="description" content="Mua bán vàng, ngọc, ngọc rồng online">
    <meta property="og:image" content="Img/NRO_TAMTRUNG.png">
    <meta property="og:url" content="https://vangngoc957.com/Home/Content/DieuKhoanSuDungChinhSachRiengTu">
    <meta property="og:title" content="VangNgoc957.com - Dịch vụ mua bán tự động">
    <meta property="fb:app_id" content="346411629526415">
    <meta property="og:image" content="Img/NRO_TAMTRUNG.png">
    ...
    <script src="/Scripts/helpers.js?v=1"></script>
    <!-- Sweetalert Css -->
    <link href="/Scripts/sweetalert/sweetalert.css" rel="stylesheet" />
    <link href="//fonts.googleapis.com/css?family=Roboto+Condensed:300,300i,400,400i,700,700i" rel="stylesheet">
    <link rel="stylesheet" href="/assets/frontend/plugins/dataTables/jquery.dataTables.min.css">
            ...
            <div class="container">
                ...
                <nav class="c-top-menu c-pull-right m-t-10">
                    <ul class="c-links c-theme-ul">
                        <li>
                            Hotline: <a href="tel:<?= setting('phone'); ?>"><?= setting('phone'); ?> (8h - 22h)</a>
                        </li>
                    </ul>
                </nav>
                <!-- END: INLINE NAV -->
            ...
            <div class="container">
                ...
                <div class="c-navbar-wrapper clearfix">
                    <div class="c-brand c-pull-left">
                        <a href="/" class="c-logo">
                            <img src="<?= setting('logo'); ?>" alt="" style="height: 50px; margin-top: -8px;" class="c-desktop-logo">
                            <img src="<?= setting('logo'); ?>" alt="" style="height: 30px; margin-top: -8px;" class="c-desktop-logo-inverse">
                            <img src="<?= setting('logo'); ?>" alt="" style="height: 23px; margin-top: -8px;" class="c-mobile-logo">
                        </a>
                        ...
                        <ul class="nav navbar-nav c-theme-nav">
                            ...
                            <li class="c-menu-type-classic">
                                ...
                                <ul id="children-of-42" class="dropdown-menu c-menu-type-classic c-pull-left ">
                                    <li class="c-menu-type-classic"><a href="/huong-dan/HD-mod">Phi&#234;n Bản Mod Hỗ Trợ Ngọc Rồng D&#224;nh Cho PC</a>
                                    </li>

                                </ul>
                            </li>
                            <?php if (data_user('admin') == 9 || data_user('admin') == 1) { ?>
                                <li class="c-menu-type-classic"><a style="color:red;" href="/admin" class="c-link dropdown-toggle">ADMIN CPANEL</a></li>
                            <?php }  ?>
                            <?php
                            if ($_SESSION['username'] == null) {
                            ?>
                                <li>
                                    <a href="/dang-nhap?refURL=/" class="c-btn-border-opacity-04 c-btn btn-no-focus c-btn-header btn btn-sm c-btn-border-1x c-btn-dark c-btn-circle c-btn-uppercase c-btn-sbold">
                            ...
                            <?php } else { ?>
                                <li>
                                    <a id="sodutk" href="/profile" style="background-color: #ed145b; border: 1px solid #ed145b; color: white;" class="_PGO c-btn-border-opacity-04 c-btn btn-no-focus c-btn-header btn btn-sm c-btn-border-1x c-btn-dark c-btn-circle c-btn-uppercase c-btn-sbold">
                                        Số dư: <?= number_format(data_user('cash')); ?> VNĐ
                                    </a>
                                </li>
                                <li>
                                    <a href="/dang-ky" class="c-btn-border-opacity-04 c-btn btn-no-focus c-btn-header btn btn-sm c-btn-border-1x c-btn-dark c-btn-circle c-btn-uppercase c-btn-sbold">
